...
pch = h.ExternalModule(
    name="sky130_fd_pr__pfet_01v8_lvt",
    desc="Sky130 PMOS",
    port_list=[
        h.Inout(name="D"),
        h.Inout(name="G"),
            ...
            for vbs_index in range(np.size(vbs_list)):
                ...
                for vgs_index in range(np.size(vgs_list)):
                    ...
                    for vds_index in range(np.size(vds_list)):
                        ...
                        tb.VBS = h.Signal()
                        if mos_type == "nch":
                            tb.dut = nch(MosParams(w=w_unit, l=lch, nf=1))(
                                D=tb.VDS, G=tb.VGS, S=tb.VSS, B=tb.VBS
                            )
                            tb.VDS_src = Vdc(Vdc.Params(dc=str(vds)))(
                                p=tb.VDS, n=tb.VSS
                            )
                            tb.VGS_src = Vdc(Vdc.Params(dc=str(vgs)))(
                                p=tb.VGS, n=tb.VSS
                            )
                            tb.VBS_src = Vdc(Vdc.Params(dc=str(vbs)))(
                                p=tb.VBS, n=tb.VSS
                            )
                        elif mos_type == "pch":
                            tb.dut = pch(MosParams(w=w_unit, l=lch, nf=1))(
                                D=tb.VDS, G=tb.VGS, S=tb.VSS, B=tb.VBS
                            )
                            tb.VDS_src = Vdc(Vdc.Params(dc=str(-vds)))(
                                p=tb.VDS, n=tb.VSS
                        ...
                        if mos_type == "nch":
                            ...
                            ids[
                                ...
                                vgs_index,
                                vds_index,
                            ] = -sim_results[0].data["i(v.xtop.vvds_src)"]
                            cgg[
                                mos_type_index,
                                lch_index,
                                vbs_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__nfet_01v8_lvt[cgg]"
                            ]
                            cdd[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__nfet_01v8_lvt[cdd]"
                            ]
                            cdd[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__nfet_01v8_lvt[cdb]"
                            ]
                            gm[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__nfet_01v8_lvt[gm]"
                            ]
                            gds[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__nfet_01v8_lvt[gds]"
                            ]
                        elif mos_type == "pch":
                            sim.literal(
                                ".save @m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[gm]"
                            )
                            sim.literal(
                                ".save @m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[gds]"
                            )
                            sim.literal(
                                ".save @m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cgg]"
                            )
                            sim.literal(
                                ".save @m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cdd]"
                            )
                            sim.literal(
                                ".save @m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cdb]"
                            )
                            sim.literal(".save all")
                            sim_results = sim.run(sim_options)
                            ids[
                            ...
                            cgg[
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cgg]"
                            ]
                            cdd[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cdd]"
                            ]
                            cdd[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[cdb]"
                            ]
                            gm[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[gm]"
                            ]
                            gds[
                                mos_type_index,
                                lch_index,
                                ...
                                "@m.xtop.xdut.msky130_fd_pr__pfet_01v8_lvt[gds]"
                            ]
